         ...
         <div className=" grid grid-cols-1 mx-auto    w-full h-full">
          <ul className="  h-3/6 w-4/6 mx-auto grid gap-40">
              <li className="   place-items-center grid grid-cols-8 mobile:grid-cols-1"> 
                 ...
                 <div class=" w-full  grid h-full  project-description rounded-lg ">
                    ...
                    <h1 className="text-2xl  mb-4" >Creatify</h1>
                        <div class="w-full h-28 mobile:h-full text-center grid  p-4 shadow-xl bg rounded-md place-items-center  bg-overlayBox">
                     ...
                     <div class="flex  place-self-end w-4/6 text-xs mobile:w-full justify-between p-1 text-right flex-row">
              ...
              <li className="   place-items-center grid grid-cols-8 mobile:grid-cols-1"> 
                 ...
                 <div class=" w-full h-full grid  project-description-right rounded-lg ">
                    ...
                    <h1 className="text-2xl  mb-4" >ChatApp</h1>
                     ...
                     <div class="flex  place-self-auto w-4/6 text-xs mobile:w-full justify-between p-1  flex-row">
                         <div className="">ReactJS</div>
              ...
              <li className="  place-items-center grid grid-cols-8 mobile:grid-cols-1"> 
                 ...
                 <div class=" w-full h-full grid  project-description rounded-lg ">
                    <div className="place-self-center  grid  mobile:text-center text-right h-1/2  bg-amber mobile:h-4/6w-full">
