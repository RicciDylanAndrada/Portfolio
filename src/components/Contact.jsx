function Contact() {
    return (
        ...
        <div class="grid mobile:flex     mobile:h-full	 w-full h-2/6 md:grid-cols-1   place-items-center">
                 <div className="grid  gap-4  w-4/6 mobile:w-full  text-center	 just mobile:gap-4   ">
                     ...
                     <div class="divider mx-auto  bg-orange w-20 h-px  2xl:w-28 "></div>
                     ...
                     <a class="button btn btn-success mx-auto w-24 border-orange bg-background text-xs" href="mailto:email@email.de">Say Hello</a>
